...
import com.shop.authservice.config.pubclient.OAuth2CustomRefreshTokenGenerator;
import com.shop.authservice.config.pubclient.PublicClientRefreshTokenAuthenticationConverter;
import com.shop.authservice.config.pubclient.PublicClientRefreshTokenAuthenticationProvider;
...
import com.shop.authservice.repository.impl.CustomRegisteredClientRepositoryImpl;
import com.shop.authservice.service.impl.CustomUserDetailsService;
import com.shop.authservice.util.JwkUtils;
...
public class AuthorizationServerConfig {
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    config.setAllowedOriginPatterns(
        Arrays.asList("http://localhost:8080*", "http://localhost:8082*", "https://auth-service*",
